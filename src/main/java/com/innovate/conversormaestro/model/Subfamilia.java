...
public class Subfamilia {
    ...
    public String toInsert() {
        return "INSERT INTO SUBFAM (cod,nom,cuc,cuv,co1,co2,co3,co4,co5,dtocom1,dtocom2,dtoven1,dtoven2,dt1,dt2,dt3,dt4,"
                +
                "dt5,d01,d02,d03,d04,d05,ma1,ma2,ma3,ma4,ma5,ima,fot,abr,pos,ctadevcom,ctadevven,ctadtocom,ctadtoven,historia,fam) "
                +
                " VALUES ('" + cod + "','" + nom + "','" + cuc + "','" + cuv + "'," + co1 + "," + co2 + "," + co3 + ","
                + co4 + "," + co5 + ",'" + dtocom1 + "','" + dtocom2 + "','" + dtoven1 + "','" + dtoven2 + "'," + dt1
                + "," + dt2 + "," + dt3 + "," + dt4 + "," + dt5 + "," + d01 + "," + d02 + "," + d03 + "," + d04 + ","
                + d05 + "," + ma1 + "," + ma2 + "," + ma3 + "," + ma4 + "," + ma5 + ",'" + ima + "','" + fot + "','"
                + abr + "','" + pos + "','" + ctadevcom + "','" + ctadevven + "','" + ctadtocom + "','" + ctadtoven
                + "','" + historia + "','" + fam + "')";
    }

    public String toUpdate() {
        return "UPDATE SUBFAM SET nom='" + nom + "',cuc='" + cuc + "',cuv='" + cuv + "',co1=" + co1
                ...
                + "',historia='" + historia + "',fam='" + fam + "' WHERE cod='" + cod + "';";
    }
}