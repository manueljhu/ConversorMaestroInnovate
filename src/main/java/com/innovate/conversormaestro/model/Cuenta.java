...
public class Cuenta {
    ...
    public String toString() {
        return "INSERT INTO CUENTA  (cue, 	nom, 	nif, 	deb, 	hab, "
                + "	dir, 	pob, 	npro, 	pro, 	cont1, 	cont2, 	cont3,"
                + " 	cont4, 	cont5, 	cons1, 	cons2, 	cons3, 	cons4, 	cons5, "
                + "	cons6, 	cons7, 	cons8, 	cons9, 	cons10, 	pais, "
                + "	gru, 	nifr, 	tdoc, 	lopd_ori, 	lopd_otr_o, "
                + "	lopd_ces, 	lopd_otr_c, 	cue_apoyo, 	lap_den, "
                + "	lap_con, 	lap_cta, 	ope_tip, 	ope_cla, "
                + "	ope_pla, 	ope_des, 	cta, 	suf, 	iban, 	"
                + "swift, 	cri_caja, 	siidesfac, 	patron, 	patron_cv)"
                + " VALUES('" + cue + "',	'" + nom + "',	'" + nif + "',	" + deb + ",	"
                + "" + hab + ",	'" + dir + "',	'" + pob + "',	" + npro + ",	"
                + "'" + pro + "',	'" + cont1 + "',	'" + cont2 + "',	'" + cont3 + "',	"
                + "'" + cont4 + "',	'" + cont5 + "',	'" + cons1 + "',	'" + cons2 + "',"
                + "	'" + cons3 + "',	'" + cons4 + "',	'" + cons5 + "',	'" + cons6 + "',"
                + "	'" + cons7 + "',	'" + cons8 + "',	'" + cons9 + "',	'" + cons10 + "',"
                + "	" + pais + ",	" + gru + ",	'" + nifr + "',	" + tdoc + ",	"
                + "" + lopd_Ori + ",	'" + lopd_Otr_O + "',	'" + lopd_Ces + "',	'" + lopd_Otr_C + "',"
                + "	'" + cue_Apoyo + "',	'" + lap_Den + "',	'" + lap_Con + "',	'" + lap_Cta + "',"
                + "	'" + ope_Tip + "',	'" + ope_Cla + "',	" + ope_Pla + ",	'" + ope_Des + "',	'" + cta + "',"
                + "	'" + suf + "',	'" + iban + "',	'" + swift + "',	'" + cri_Caja + "',	'" + siidesfac + "',"
                + "	'" + patron + "',	'" + patron_Cv + "');";
