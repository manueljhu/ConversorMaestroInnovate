                ...
                try {
                    switch (relaciones.get(j).getCampoDestino()) {
                        ...
                        case "ufc":
                            ...
                            break;
                        case "pro":
                            articulo.setPro(formatUtils.format6digits(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen()))));
                            break;
                        case "pmv":
                        ...
                        case "art_minped":
                            ...
                            break;
                        case "art_subfam":
                            articulo.setArt_Subfam(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "art_marca":
                            articulo.setArt_Marca(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "web_nov":
                            articulo.setWeb_Nov(
                        ...
                        case "web_sub":
                            ...
                            break;
                        case "web_actd":
                            articulo.setWeb_Actd(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "web_acth":
                            articulo.setWeb_Acth(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "divs1":
                            articulo.setDivs1(
                        ...
                        case "web_orcat3":
                            ...
                            break;
                        case "web_metat":
                            articulo.setWeb_Metat(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "web_metad":
                            articulo.setWeb_Metad(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "web_urla":
                            articulo.setWeb_Urla(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "web_h1":
                            articulo.setWeb_H1(
                            ...
                            break;
                        case "web_h2_1":
                            articulo.setWeb_H2_1(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "web_h2_2":
                            articulo.setWeb_H2_2(
                                    SQLUtils.devuelveString(hashtable.get(relaciones.get(j).getCampoOrigen())));
                            break;
                        case "sincro":
                            articulo.setSincro(
