                ...
                try {
                    switch (relaciones.get(j).getCampoDestino()) {
                        ...
                        case "fea":
                            ...
                            break;
                        case "doc":
                            facturaEmitida.setDoc(formatUtils
                        ...
                        case "fee":
                            ...
                            break;
                        case "gas":
                            facturaEmitida.setGas(formatUtils
                                    .format6digits(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "cue":
                        ...
                        case "den":
                            ...
                            break;
                        case "rut":
                            facturaEmitida.setRut(formatUtils
                                    .format6digits(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "obr":
                        ...
                        case "efacgen":
                            facturaEmitida
                                    .setEfacgen(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "efacenv":
                            facturaEmitida
                                    .setEfacenv(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "sno":
                        ...
                        case "emi_deb_pag":
                            facturaEmitida
                                    .setEmi_Deb_Pag(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "emi_incluir":
                            facturaEmitida
                                    .setEmi_Incluir(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "emi_antes_dto":
                        ...
                        case "emi_iva_inc":
                            facturaEmitida
                                    .setEmi_Iva_Inc(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "moneda":
                        ...
                        case "retgar":
                            facturaEmitida
                                    .setRetgar(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "porretgar":
                        ...
                        case "tipretgar":
                            facturaEmitida
                                    .setTipretgar(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "suplidos":
                        ...
                        case "numtic":
                            facturaEmitida
                                    .setNumtic(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "cri_caja":
                            facturaEmitida
                        ...
                        case "cen_adm":
                            facturaEmitida
                                    .setCen_Adm(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siiest":
                            facturaEmitida
                        ...
                        case "siifraemi":
                            facturaEmitida
                                    .setSiifraemi(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siitiprec":
                            facturaEmitida
                        ...
                        case "siitipsuj":
                            facturaEmitida
                                    .setSiitipsuj(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siitipnsu":
                            facturaEmitida
                                    .setSiitipnsu(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siitipexe":
                            facturaEmitida
                                    .setSiitipexe(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siidesfra":
                            facturaEmitida
                        ...
                        case "siiemiter":
                            facturaEmitida
                                    .setSiiemiter(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siicupon":
                            facturaEmitida
                                    .setSiicupon(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siivardes":
                            facturaEmitida
                                    .setSiivardes(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siidatrec":
                            facturaEmitida
                        ...
                        case "siidatinm":
                            facturaEmitida
                                    .setSiidatinm(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siidatagr":
                            facturaEmitida
                        ...
                        case "siientcexe":
                            facturaEmitida
                                    .setSiientcexe(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siienttsuj":
                            facturaEmitida
                                    .setSiienttsuj(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siientnsu":
                        ...
                        case "siientdes":
                            facturaEmitida
                                    .setSiientdes(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siiserexe":
                        ...
                        case "siisercexe":
                            facturaEmitida
                                    .setSiisercexe(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siisertsuj":
                            facturaEmitida
                                    .setSiisertsuj(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siisernsu":
                        ...
                        case "siiserdes":
                            facturaEmitida
                                    .setSiiserdes(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siidatdes":
                            facturaEmitida
                        ...
                        case "siifraemi1":
                            facturaEmitida
                                    .setSiifraemi1(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siifraemi2":
                            facturaEmitida
                                    .setSiifraemi2(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siinumacu":
                            facturaEmitida
                        ...
                        case "siinemiter":
                            facturaEmitida
                                    .setSiinemiter(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siidesman":
                            facturaEmitida
                        ...
                        case "siidesnoid":
                            facturaEmitida
                                    .setSiidesnoid(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siifraiden":
                            facturaEmitida
                        ...
                        case "siimergas":
                            facturaEmitida
                                    .setSiimergas(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siidesexen":
                            facturaEmitida
                                    .setSiidesexen(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siimacro":
                            facturaEmitida
                        ...
                        case "siientdexe":
                            facturaEmitida
                                    .setSiientdexe(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "siiserdexe":
                            facturaEmitida
                                    .setSiiserdexe(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "aeattipfac":
                            facturaEmitida
                        ...
                        case "aeattiping":
                            facturaEmitida
                                    .setAeattiping(DBFUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "aeatimpcon":
