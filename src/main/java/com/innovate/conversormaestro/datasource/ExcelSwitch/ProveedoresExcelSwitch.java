...
public class ProveedoresExcelSwitch {
                ...
                try {
                    switch (relaciones.get(j).getCampoDestino()) {
                        ...
                        case "car":
                            ...
                            break;
                        case "forpag":
                            proveedor.setForpag(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "dto":
                            proveedor.setDto(Float
                        ...
                        case "mar":
                            ...
                            break;
                        case "dt2":
                            proveedor.setDt2(Float
                                    .parseFloat(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "di1":
                            proveedor.setDi1(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "di2":
                            proveedor.setDi2(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "di3":
                            proveedor.setDi3(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "mnp":
                            proveedor.setMnp(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "tia":
                            ...
                            break;
                        case "tre":
                            proveedor.setTre(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "ret":
                            proveedor.setRet(Float
                                    .parseFloat(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "ob1":
                        ...
                        case "ext":
                            ...
                            break;
                        case "rediva1":
                            proveedor.setRediva1(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "rediva2":
                            proveedor.setRediva2(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "rediva3":
                            proveedor.setRediva3(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "rediva4":
                            proveedor.setRediva4(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "rediva5":
                            proveedor.setRediva5(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "avi0ped":
                            proveedor.setAvi0Ped(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "avi1ped":
                        ...
                        case "xxx":
                            ...
                            break;
                        case "imprap":
                            proveedor.setImprap(Float
                                    .parseFloat(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "dtorap":
                            proveedor.setDtorap(Float
                                    .parseFloat(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "perrap":
                            proveedor.setPerrap(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "v01":
                        ...
                        case "lopd_Otr_C":
                            ...
                            break;
                        case "pro_idioma":
                            proveedor.setPro_Idioma(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "moneda":
                            proveedor.setMoneda(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "avi_Ped":
                        ...
                        case "actividad":
                            proveedor
                                    .setActividad(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen()));
                            break;
                        case "contrato":
                        ...
                        case "cer_Pre":
                            ...
                            break;
                        case "perval":
                            proveedor.setPerval(Float
                                    .parseFloat(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "diasmax":
                            proveedor.setDiasmax(Integer
                                    .parseInt(excelUtils.devuelveValorCelda(i, relaciones.get(j).getCampoOrigen())));
                            break;
                        case "autof":
